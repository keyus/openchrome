...
export default {
    async connect() {
        //C:\\Users\\kissw\\AppData\\Roaming\\com.airdrop.app\\chrome.db
        return await Database.load(`sqlite:chrome.db`)
    },
    ...
    async getAll() {
        const db = await this.connect();
        return db.select('select id, name, group_name, localtion, tags, mark, chrome_version, last_open_time from chrome');
    },
